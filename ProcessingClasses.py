...
# SOrellana, 6/8/2022, used listing code to create module
# ---------------------------------------------------------- #
...
class FileProcessor:
    ...
    changelog: (When,Who,What)
        ...
        SOrellana, 6.8.2022, Corrected code for read_data to load list of objects, not lists
    """
    ...
    def read_data_from_file(file_name: str):
        ...
        try:
            ...
            for line in file:
                emp_id, emp_first_n, emp_last_n = line.split(",")
                obj_emp = DC.Employee(emp_id, emp_first_n, emp_last_n.strip())
                list_of_rows.append(obj_emp)
            file.close()
        except Exception as e:
            print("There was a general error!")
            print(e, e.__doc__, type(e), sep='\n')
